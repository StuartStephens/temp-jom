...
export interface IInspirationalMessageBlockProps extends ITodaysWordFormBlock {}

export function InspirationalMessageBlock(
  props: IInspirationalMessageBlockProps
) {
