...
export function ContentListItem(props: IContentListItemProps) {
  ...
  console.log("ContentListItem contentType", contentType);
  ...
  return (
    ...
    >
      ...
      '${thumbnailUrl}'
            ...
            <Card.Body>
              <div className="card-item-body-wrapper d-flex flex-column">
                <Link className="card-item-body-content" href={`${launchUrl}`}>
