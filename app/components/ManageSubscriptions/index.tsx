...
import useEmailSubscriptionAPI from "../../contexts/Auth/EmailSubscriptionsAPI";
...
export function ManageSubscriptions(props: IManageSubscriptionsProps) {
  ...
  // NEXT STEP IS GET THIS DATA VIA API

  const { getEmailSubscriptionsByEmail } = useEmailSubscriptionAPI();
